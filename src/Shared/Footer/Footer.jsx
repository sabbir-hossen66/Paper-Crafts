...
const Footer = () => {
  return (
    ...
    <footer className="px-4 divide-y py-8  bg-[#24324A] text-white">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            ...
            <span className="self-center text-white text-2xl font-semibold">Paper_Craft</span>
          </a>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-">Product</h3>
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-white">Crafts</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">Public papers</a>
              </li>
              <li>
                <a rel="noopener noreferrer" href="#">Buy</a>
              </li>
              <li>

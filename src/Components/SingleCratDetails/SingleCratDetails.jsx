...
const SingleCratDetails = () => {
  ...
  return (
    <div>
      <h2 className="text-3xl py-6 text-center font-semibold">This is Craft Details Page</h2>
      <div className="max-w-screen-2xl mx-auto mb-14 p-4  shadow-md bg-gray-50 text-gray-800">
